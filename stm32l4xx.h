...
struct DAC_Type {
	...
	__IO uint32_t DHR12R1; // @8 channel1 12-bit right-aligned data holding register
	__IO uint32_t DHR12L1; // @12 channel1 12-bit left-aligned data holding register
	__IO uint32_t DHR8R1; // @16 channel1 8-bit right-aligned data holding register
	__IO uint32_t DHR12R2; // @20 channel2 12-bit right aligned data holding register
	__IO uint32_t DHR12L2; // @24 channel2 12-bit left aligned data holding register
	__IO uint32_t DHR8R2; // @28 channel2 8-bit right-aligned data holding register
	...
	__IO uint32_t DHR8RD; // @40 DUAL DAC 8-bit right aligned data holding register
...
enum {
	DAC_DHR8R1_DACC1DHR = ((1UL<<8)-1) << 0, // DAC channel1 8-bit right-aligned data		
};
static inline void dac_dhr8r1_set_dacc1dhr(uint32_t val) { DAC1.DHR8R1 = (DAC1.DHR8R1 & ~DAC_DHR8R1_DACC1DHR) | ((val<<0) & DAC_DHR8R1_DACC1DHR); }
static inline uint32_t dac_dhr8r1_get_dacc1dhr(void) { return (DAC1.DHR8R1 & DAC_DHR8R1_DACC1DHR) >> 0 ; }
...
enum {
	DAC_DHR8R2_DACC2DHR = ((1UL<<8)-1) << 0, // DAC channel2 8-bit right-aligned data		
};
static inline void dac_dhr8r2_set_dacc2dhr(uint32_t val) { DAC1.DHR8R2 = (DAC1.DHR8R2 & ~DAC_DHR8R2_DACC2DHR) | ((val<<0) & DAC_DHR8R2_DACC2DHR); }
static inline uint32_t dac_dhr8r2_get_dacc2dhr(void) { return (DAC1.DHR8R2 & DAC_DHR8R2_DACC2DHR) >> 0 ; }
...
static inline void firewall_cssa_set_add(uint32_t val) { FIREWALL.CSSA = (FIREWALL.CSSA & ~FIREWALL_CSSA_ADD) | ((val<<8) & FIREWALL_CSSA_ADD); }
...
static inline void firewall_csl_set_leng(uint32_t val) { FIREWALL.CSL = (FIREWALL.CSL & ~FIREWALL_CSL_LENG) | ((val<<8) & FIREWALL_CSL_LENG); }
...
static inline void firewall_nvdssa_set_add(uint32_t val) { FIREWALL.NVDSSA = (FIREWALL.NVDSSA & ~FIREWALL_NVDSSA_ADD) | ((val<<8) & FIREWALL_NVDSSA_ADD); }
...
static inline void firewall_nvdsl_set_leng(uint32_t val) { FIREWALL.NVDSL = (FIREWALL.NVDSL & ~FIREWALL_NVDSL_LENG) | ((val<<8) & FIREWALL_NVDSL_LENG); }
...
static inline void firewall_vdssa_set_add(uint32_t val) { FIREWALL.VDSSA = (FIREWALL.VDSSA & ~FIREWALL_VDSSA_ADD) | ((val<<6) & FIREWALL_VDSSA_ADD); }
...
static inline void firewall_vdsl_set_leng(uint32_t val) { FIREWALL.VDSL = (FIREWALL.VDSL & ~FIREWALL_VDSL_LENG) | ((val<<6) & FIREWALL_VDSL_LENG); }
...
static inline void flash_pcrop2sr_set_pcrop2_strt(uint32_t val) { FLASH.PCROP2SR = (FLASH.PCROP2SR & ~FLASH_PCROP2SR_PCROP2_STRT) | ((val<<0) & FLASH_PCROP2SR_PCROP2_STRT); }
...
static inline void flash_pcrop2er_set_pcrop2_end(uint32_t val) { FLASH.PCROP2ER = (FLASH.PCROP2ER & ~FLASH_PCROP2ER_PCROP2_END) | ((val<<0) & FLASH_PCROP2ER_PCROP2_END); }
...
static inline void i2c_txdr_set_txdata(struct I2C_Type* p, uint32_t val) { p->TXDR = (p->TXDR & ~I2C_TXDR_TXDATA) | ((val<<0) & I2C_TXDR_TXDATA); }
...
static inline void lptim_cmp_set_cmp(struct LPTIM_Type* p, uint32_t val) { p->CMP = (p->CMP & ~LPTIM_CMP_CMP) | ((val<<0) & LPTIM_CMP_CMP); }
...
static inline void lptim_arr_set_arr(struct LPTIM_Type* p, uint32_t val) { p->ARR = (p->ARR & ~LPTIM_ARR_ARR) | ((val<<0) & LPTIM_ARR_ARR); }
...
struct OPAMP_Type {
	...
	__IO uint32_t OPAMP1_LPOTR; // @8 OPAMP1 offset trimming register in low-power mode
	 uint8_t RESERVED0[4]; // @12 
	__IO uint32_t OPAMP2_CSR; // @16 OPAMP2 control/status register
	__IO uint32_t OPAMP2_OTR; // @20 OPAMP2 offset trimming register in normal mode
	__IO uint32_t OPAMP2_LPOTR; // @24 OPAMP2 offset trimming register in low-power mode
};
...
static inline void opamp_opamp1_csr_set_vm_sel(uint32_t val) { OPAMP.OPAMP1_CSR = (OPAMP.OPAMP1_CSR & ~OPAMP_OPAMP1_CSR_VM_SEL) | ((val<<8) & OPAMP_OPAMP1_CSR_VM_SEL); }
static inline void opamp_opamp1_csr_set_pga_gain(uint32_t val) { OPAMP.OPAMP1_CSR = (OPAMP.OPAMP1_CSR & ~OPAMP_OPAMP1_CSR_PGA_GAIN) | ((val<<4) & OPAMP_OPAMP1_CSR_PGA_GAIN); }
static inline void opamp_opamp1_csr_set_opamode(uint32_t val) { OPAMP.OPAMP1_CSR = (OPAMP.OPAMP1_CSR & ~OPAMP_OPAMP1_CSR_OPAMODE) | ((val<<2) & OPAMP_OPAMP1_CSR_OPAMODE); }
static inline uint32_t opamp_opamp1_csr_get_vm_sel(void) { return (OPAMP.OPAMP1_CSR & OPAMP_OPAMP1_CSR_VM_SEL) >> 8 ; }
static inline uint32_t opamp_opamp1_csr_get_pga_gain(void) { return (OPAMP.OPAMP1_CSR & OPAMP_OPAMP1_CSR_PGA_GAIN) >> 4 ; }
static inline uint32_t opamp_opamp1_csr_get_opamode(void) { return (OPAMP.OPAMP1_CSR & OPAMP_OPAMP1_CSR_OPAMODE) >> 2 ; }
...
static inline void opamp_opamp1_otr_set_trimoffsetp(uint32_t val) { OPAMP.OPAMP1_OTR = (OPAMP.OPAMP1_OTR & ~OPAMP_OPAMP1_OTR_TRIMOFFSETP) | ((val<<8) & OPAMP_OPAMP1_OTR_TRIMOFFSETP); }
static inline void opamp_opamp1_otr_set_trimoffsetn(uint32_t val) { OPAMP.OPAMP1_OTR = (OPAMP.OPAMP1_OTR & ~OPAMP_OPAMP1_OTR_TRIMOFFSETN) | ((val<<0) & OPAMP_OPAMP1_OTR_TRIMOFFSETN); }
static inline uint32_t opamp_opamp1_otr_get_trimoffsetp(void) { return (OPAMP.OPAMP1_OTR & OPAMP_OPAMP1_OTR_TRIMOFFSETP) >> 8 ; }
static inline uint32_t opamp_opamp1_otr_get_trimoffsetn(void) { return (OPAMP.OPAMP1_OTR & OPAMP_OPAMP1_OTR_TRIMOFFSETN) >> 0 ; }
...
static inline void opamp_opamp1_lpotr_set_trimlpoffsetp(uint32_t val) { OPAMP.OPAMP1_LPOTR = (OPAMP.OPAMP1_LPOTR & ~OPAMP_OPAMP1_LPOTR_TRIMLPOFFSETP) | ((val<<8) & OPAMP_OPAMP1_LPOTR_TRIMLPOFFSETP); }
static inline void opamp_opamp1_lpotr_set_trimlpoffsetn(uint32_t val) { OPAMP.OPAMP1_LPOTR = (OPAMP.OPAMP1_LPOTR & ~OPAMP_OPAMP1_LPOTR_TRIMLPOFFSETN) | ((val<<0) & OPAMP_OPAMP1_LPOTR_TRIMLPOFFSETN); }
static inline uint32_t opamp_opamp1_lpotr_get_trimlpoffsetp(void) { return (OPAMP.OPAMP1_LPOTR & OPAMP_OPAMP1_LPOTR_TRIMLPOFFSETP) >> 8 ; }
static inline uint32_t opamp_opamp1_lpotr_get_trimlpoffsetn(void) { return (OPAMP.OPAMP1_LPOTR & OPAMP_OPAMP1_LPOTR_TRIMLPOFFSETN) >> 0 ; }
...
static inline void opamp_opamp2_csr_set_vm_sel(uint32_t val) { OPAMP.OPAMP2_CSR = (OPAMP.OPAMP2_CSR & ~OPAMP_OPAMP2_CSR_VM_SEL) | ((val<<8) & OPAMP_OPAMP2_CSR_VM_SEL); }
static inline void opamp_opamp2_csr_set_pga_gain(uint32_t val) { OPAMP.OPAMP2_CSR = (OPAMP.OPAMP2_CSR & ~OPAMP_OPAMP2_CSR_PGA_GAIN) | ((val<<4) & OPAMP_OPAMP2_CSR_PGA_GAIN); }
static inline void opamp_opamp2_csr_set_opamode(uint32_t val) { OPAMP.OPAMP2_CSR = (OPAMP.OPAMP2_CSR & ~OPAMP_OPAMP2_CSR_OPAMODE) | ((val<<2) & OPAMP_OPAMP2_CSR_OPAMODE); }
static inline uint32_t opamp_opamp2_csr_get_vm_sel(void) { return (OPAMP.OPAMP2_CSR & OPAMP_OPAMP2_CSR_VM_SEL) >> 8 ; }
static inline uint32_t opamp_opamp2_csr_get_pga_gain(void) { return (OPAMP.OPAMP2_CSR & OPAMP_OPAMP2_CSR_PGA_GAIN) >> 4 ; }
static inline uint32_t opamp_opamp2_csr_get_opamode(void) { return (OPAMP.OPAMP2_CSR & OPAMP_OPAMP2_CSR_OPAMODE) >> 2 ; }
...
static inline void opamp_opamp2_otr_set_trimoffsetp(uint32_t val) { OPAMP.OPAMP2_OTR = (OPAMP.OPAMP2_OTR & ~OPAMP_OPAMP2_OTR_TRIMOFFSETP) | ((val<<8) & OPAMP_OPAMP2_OTR_TRIMOFFSETP); }
static inline void opamp_opamp2_otr_set_trimoffsetn(uint32_t val) { OPAMP.OPAMP2_OTR = (OPAMP.OPAMP2_OTR & ~OPAMP_OPAMP2_OTR_TRIMOFFSETN) | ((val<<0) & OPAMP_OPAMP2_OTR_TRIMOFFSETN); }
static inline uint32_t opamp_opamp2_otr_get_trimoffsetp(void) { return (OPAMP.OPAMP2_OTR & OPAMP_OPAMP2_OTR_TRIMOFFSETP) >> 8 ; }
static inline uint32_t opamp_opamp2_otr_get_trimoffsetn(void) { return (OPAMP.OPAMP2_OTR & OPAMP_OPAMP2_OTR_TRIMOFFSETN) >> 0 ; }
...
static inline void opamp_opamp2_lpotr_set_trimlpoffsetp(uint32_t val) { OPAMP.OPAMP2_LPOTR = (OPAMP.OPAMP2_LPOTR & ~OPAMP_OPAMP2_LPOTR_TRIMLPOFFSETP) | ((val<<8) & OPAMP_OPAMP2_LPOTR_TRIMLPOFFSETP); }
static inline void opamp_opamp2_lpotr_set_trimlpoffsetn(uint32_t val) { OPAMP.OPAMP2_LPOTR = (OPAMP.OPAMP2_LPOTR & ~OPAMP_OPAMP2_LPOTR_TRIMLPOFFSETN) | ((val<<0) & OPAMP_OPAMP2_LPOTR_TRIMLPOFFSETN); }
static inline uint32_t opamp_opamp2_lpotr_get_trimlpoffsetp(void) { return (OPAMP.OPAMP2_LPOTR & OPAMP_OPAMP2_LPOTR_TRIMLPOFFSETP) >> 8 ; }
static inline uint32_t opamp_opamp2_lpotr_get_trimlpoffsetn(void) { return (OPAMP.OPAMP2_LPOTR & OPAMP_OPAMP2_LPOTR_TRIMLPOFFSETN) >> 0 ; }
...
static inline void quadspi_cr_set_prescaler(uint32_t val) { QUADSPI.CR = (QUADSPI.CR & ~QUADSPI_CR_PRESCALER) | ((val<<24) & QUADSPI_CR_PRESCALER); }
static inline void quadspi_cr_set_fthres(uint32_t val) { QUADSPI.CR = (QUADSPI.CR & ~QUADSPI_CR_FTHRES) | ((val<<8) & QUADSPI_CR_FTHRES); }
static inline uint32_t quadspi_cr_get_prescaler(void) { return (QUADSPI.CR & QUADSPI_CR_PRESCALER) >> 24 ; }
static inline uint32_t quadspi_cr_get_fthres(void) { return (QUADSPI.CR & QUADSPI_CR_FTHRES) >> 8 ; }
...
static inline void quadspi_dcr_set_fsize(uint32_t val) { QUADSPI.DCR = (QUADSPI.DCR & ~QUADSPI_DCR_FSIZE) | ((val<<16) & QUADSPI_DCR_FSIZE); }
static inline void quadspi_dcr_set_csht(uint32_t val) { QUADSPI.DCR = (QUADSPI.DCR & ~QUADSPI_DCR_CSHT) | ((val<<8) & QUADSPI_DCR_CSHT); }
static inline uint32_t quadspi_dcr_get_fsize(void) { return (QUADSPI.DCR & QUADSPI_DCR_FSIZE) >> 16 ; }
static inline uint32_t quadspi_dcr_get_csht(void) { return (QUADSPI.DCR & QUADSPI_DCR_CSHT) >> 8 ; }
...
static inline uint32_t quadspi_sr_get_flevel(void) { return (QUADSPI.SR & QUADSPI_SR_FLEVEL) >> 8 ; }
...
static inline void quadspi_ccr_set_fmode(uint32_t val) { QUADSPI.CCR = (QUADSPI.CCR & ~QUADSPI_CCR_FMODE) | ((val<<26) & QUADSPI_CCR_FMODE); }
static inline void quadspi_ccr_set_dmode(uint32_t val) { QUADSPI.CCR = (QUADSPI.CCR & ~QUADSPI_CCR_DMODE) | ((val<<24) & QUADSPI_CCR_DMODE); }
static inline void quadspi_ccr_set_dcyc(uint32_t val) { QUADSPI.CCR = (QUADSPI.CCR & ~QUADSPI_CCR_DCYC) | ((val<<18) & QUADSPI_CCR_DCYC); }
static inline void quadspi_ccr_set_absize(uint32_t val) { QUADSPI.CCR = (QUADSPI.CCR & ~QUADSPI_CCR_ABSIZE) | ((val<<16) & QUADSPI_CCR_ABSIZE); }
static inline void quadspi_ccr_set_abmode(uint32_t val) { QUADSPI.CCR = (QUADSPI.CCR & ~QUADSPI_CCR_ABMODE) | ((val<<14) & QUADSPI_CCR_ABMODE); }
static inline void quadspi_ccr_set_adsize(uint32_t val) { QUADSPI.CCR = (QUADSPI.CCR & ~QUADSPI_CCR_ADSIZE) | ((val<<12) & QUADSPI_CCR_ADSIZE); }
static inline void quadspi_ccr_set_admode(uint32_t val) { QUADSPI.CCR = (QUADSPI.CCR & ~QUADSPI_CCR_ADMODE) | ((val<<10) & QUADSPI_CCR_ADMODE); }
static inline void quadspi_ccr_set_imode(uint32_t val) { QUADSPI.CCR = (QUADSPI.CCR & ~QUADSPI_CCR_IMODE) | ((val<<8) & QUADSPI_CCR_IMODE); }
static inline void quadspi_ccr_set_instruction(uint32_t val) { QUADSPI.CCR = (QUADSPI.CCR & ~QUADSPI_CCR_INSTRUCTION) | ((val<<0) & QUADSPI_CCR_INSTRUCTION); }
static inline uint32_t quadspi_ccr_get_fmode(void) { return (QUADSPI.CCR & QUADSPI_CCR_FMODE) >> 26 ; }
static inline uint32_t quadspi_ccr_get_dmode(void) { return (QUADSPI.CCR & QUADSPI_CCR_DMODE) >> 24 ; }
static inline uint32_t quadspi_ccr_get_dcyc(void) { return (QUADSPI.CCR & QUADSPI_CCR_DCYC) >> 18 ; }
static inline uint32_t quadspi_ccr_get_absize(void) { return (QUADSPI.CCR & QUADSPI_CCR_ABSIZE) >> 16 ; }
static inline uint32_t quadspi_ccr_get_abmode(void) { return (QUADSPI.CCR & QUADSPI_CCR_ABMODE) >> 14 ; }
static inline uint32_t quadspi_ccr_get_adsize(void) { return (QUADSPI.CCR & QUADSPI_CCR_ADSIZE) >> 12 ; }
static inline uint32_t quadspi_ccr_get_admode(void) { return (QUADSPI.CCR & QUADSPI_CCR_ADMODE) >> 10 ; }
static inline uint32_t quadspi_ccr_get_imode(void) { return (QUADSPI.CCR & QUADSPI_CCR_IMODE) >> 8 ; }
static inline uint32_t quadspi_ccr_get_instruction(void) { return (QUADSPI.CCR & QUADSPI_CCR_INSTRUCTION) >> 0 ; }

// QUADSPI->PIR polling interval register
enum {
	QUADSPI_PIR_INTERVAL = ((1UL<<16)-1) << 0, // Polling interval		
};
static inline void quadspi_pir_set_interval(uint32_t val) { QUADSPI.PIR = (QUADSPI.PIR & ~QUADSPI_PIR_INTERVAL) | ((val<<0) & QUADSPI_PIR_INTERVAL); }
static inline uint32_t quadspi_pir_get_interval(void) { return (QUADSPI.PIR & QUADSPI_PIR_INTERVAL) >> 0 ; }

// QUADSPI->LPTR low-power timeout register
enum {
	QUADSPI_LPTR_TIMEOUT = ((1UL<<16)-1) << 0, // Timeout period		
};
static inline void quadspi_lptr_set_timeout(uint32_t val) { QUADSPI.LPTR = (QUADSPI.LPTR & ~QUADSPI_LPTR_TIMEOUT) | ((val<<0) & QUADSPI_LPTR_TIMEOUT); }
static inline uint32_t quadspi_lptr_get_timeout(void) { return (QUADSPI.LPTR & QUADSPI_LPTR_TIMEOUT) >> 0 ; }
...
static inline void sai_acr1_set_mcjdiv(uint32_t val) { SAI1.ACR1 = (SAI1.ACR1 & ~SAI_ACR1_MCJDIV) | ((val<<20) & SAI_ACR1_MCJDIV); }
static inline void sai_acr1_set_syncen(uint32_t val) { SAI1.ACR1 = (SAI1.ACR1 & ~SAI_ACR1_SYNCEN) | ((val<<10) & SAI_ACR1_SYNCEN); }
static inline void sai_acr1_set_ds(uint32_t val) { SAI1.ACR1 = (SAI1.ACR1 & ~SAI_ACR1_DS) | ((val<<5) & SAI_ACR1_DS); }
static inline void sai_acr1_set_prtcfg(uint32_t val) { SAI1.ACR1 = (SAI1.ACR1 & ~SAI_ACR1_PRTCFG) | ((val<<2) & SAI_ACR1_PRTCFG); }
static inline void sai_acr1_set_mode(uint32_t val) { SAI1.ACR1 = (SAI1.ACR1 & ~SAI_ACR1_MODE) | ((val<<0) & SAI_ACR1_MODE); }
static inline uint32_t sai_acr1_get_mcjdiv(void) { return (SAI1.ACR1 & SAI_ACR1_MCJDIV) >> 20 ; }
static inline uint32_t sai_acr1_get_syncen(void) { return (SAI1.ACR1 & SAI_ACR1_SYNCEN) >> 10 ; }
static inline uint32_t sai_acr1_get_ds(void) { return (SAI1.ACR1 & SAI_ACR1_DS) >> 5 ; }
static inline uint32_t sai_acr1_get_prtcfg(void) { return (SAI1.ACR1 & SAI_ACR1_PRTCFG) >> 2 ; }
static inline uint32_t sai_acr1_get_mode(void) { return (SAI1.ACR1 & SAI_ACR1_MODE) >> 0 ; }
...
static inline void sai_acr2_set_comp(uint32_t val) { SAI1.ACR2 = (SAI1.ACR2 & ~SAI_ACR2_COMP) | ((val<<14) & SAI_ACR2_COMP); }
static inline void sai_acr2_set_mutecn(uint32_t val) { SAI1.ACR2 = (SAI1.ACR2 & ~SAI_ACR2_MUTECN) | ((val<<7) & SAI_ACR2_MUTECN); }
static inline void sai_acr2_set_fth(uint32_t val) { SAI1.ACR2 = (SAI1.ACR2 & ~SAI_ACR2_FTH) | ((val<<0) & SAI_ACR2_FTH); }
static inline uint32_t sai_acr2_get_comp(void) { return (SAI1.ACR2 & SAI_ACR2_COMP) >> 14 ; }
static inline uint32_t sai_acr2_get_mutecn(void) { return (SAI1.ACR2 & SAI_ACR2_MUTECN) >> 7 ; }
static inline uint32_t sai_acr2_get_fth(void) { return (SAI1.ACR2 & SAI_ACR2_FTH) >> 0 ; }
...
static inline void sai_afrcr_set_fsall(uint32_t val) { SAI1.AFRCR = (SAI1.AFRCR & ~SAI_AFRCR_FSALL) | ((val<<8) & SAI_AFRCR_FSALL); }
static inline void sai_afrcr_set_frl(uint32_t val) { SAI1.AFRCR = (SAI1.AFRCR & ~SAI_AFRCR_FRL) | ((val<<0) & SAI_AFRCR_FRL); }
static inline uint32_t sai_afrcr_get_fsall(void) { return (SAI1.AFRCR & SAI_AFRCR_FSALL) >> 8 ; }
static inline uint32_t sai_afrcr_get_frl(void) { return (SAI1.AFRCR & SAI_AFRCR_FRL) >> 0 ; }
...
static inline void sai_aslotr_set_sloten(uint32_t val) { SAI1.ASLOTR = (SAI1.ASLOTR & ~SAI_ASLOTR_SLOTEN) | ((val<<16) & SAI_ASLOTR_SLOTEN); }
static inline void sai_aslotr_set_nbslot(uint32_t val) { SAI1.ASLOTR = (SAI1.ASLOTR & ~SAI_ASLOTR_NBSLOT) | ((val<<8) & SAI_ASLOTR_NBSLOT); }
static inline void sai_aslotr_set_slotsz(uint32_t val) { SAI1.ASLOTR = (SAI1.ASLOTR & ~SAI_ASLOTR_SLOTSZ) | ((val<<6) & SAI_ASLOTR_SLOTSZ); }
static inline void sai_aslotr_set_fboff(uint32_t val) { SAI1.ASLOTR = (SAI1.ASLOTR & ~SAI_ASLOTR_FBOFF) | ((val<<0) & SAI_ASLOTR_FBOFF); }
static inline uint32_t sai_aslotr_get_sloten(void) { return (SAI1.ASLOTR & SAI_ASLOTR_SLOTEN) >> 16 ; }
static inline uint32_t sai_aslotr_get_nbslot(void) { return (SAI1.ASLOTR & SAI_ASLOTR_NBSLOT) >> 8 ; }
static inline uint32_t sai_aslotr_get_slotsz(void) { return (SAI1.ASLOTR & SAI_ASLOTR_SLOTSZ) >> 6 ; }
static inline uint32_t sai_aslotr_get_fboff(void) { return (SAI1.ASLOTR & SAI_ASLOTR_FBOFF) >> 0 ; }
...
static inline void sai_asr_set_flvl(uint32_t val) { SAI1.ASR = (SAI1.ASR & ~SAI_ASR_FLVL) | ((val<<16) & SAI_ASR_FLVL); }
static inline uint32_t sai_asr_get_flvl(void) { return (SAI1.ASR & SAI_ASR_FLVL) >> 16 ; }
...
static inline void sai_bcr1_set_mcjdiv(uint32_t val) { SAI1.BCR1 = (SAI1.BCR1 & ~SAI_BCR1_MCJDIV) | ((val<<20) & SAI_BCR1_MCJDIV); }
static inline void sai_bcr1_set_syncen(uint32_t val) { SAI1.BCR1 = (SAI1.BCR1 & ~SAI_BCR1_SYNCEN) | ((val<<10) & SAI_BCR1_SYNCEN); }
static inline void sai_bcr1_set_ds(uint32_t val) { SAI1.BCR1 = (SAI1.BCR1 & ~SAI_BCR1_DS) | ((val<<5) & SAI_BCR1_DS); }
static inline void sai_bcr1_set_prtcfg(uint32_t val) { SAI1.BCR1 = (SAI1.BCR1 & ~SAI_BCR1_PRTCFG) | ((val<<2) & SAI_BCR1_PRTCFG); }
static inline void sai_bcr1_set_mode(uint32_t val) { SAI1.BCR1 = (SAI1.BCR1 & ~SAI_BCR1_MODE) | ((val<<0) & SAI_BCR1_MODE); }
static inline uint32_t sai_bcr1_get_mcjdiv(void) { return (SAI1.BCR1 & SAI_BCR1_MCJDIV) >> 20 ; }
static inline uint32_t sai_bcr1_get_syncen(void) { return (SAI1.BCR1 & SAI_BCR1_SYNCEN) >> 10 ; }
static inline uint32_t sai_bcr1_get_ds(void) { return (SAI1.BCR1 & SAI_BCR1_DS) >> 5 ; }
static inline uint32_t sai_bcr1_get_prtcfg(void) { return (SAI1.BCR1 & SAI_BCR1_PRTCFG) >> 2 ; }
static inline uint32_t sai_bcr1_get_mode(void) { return (SAI1.BCR1 & SAI_BCR1_MODE) >> 0 ; }
...
static inline void sai_bcr2_set_comp(uint32_t val) { SAI1.BCR2 = (SAI1.BCR2 & ~SAI_BCR2_COMP) | ((val<<14) & SAI_BCR2_COMP); }
static inline void sai_bcr2_set_mutecn(uint32_t val) { SAI1.BCR2 = (SAI1.BCR2 & ~SAI_BCR2_MUTECN) | ((val<<7) & SAI_BCR2_MUTECN); }
static inline void sai_bcr2_set_fth(uint32_t val) { SAI1.BCR2 = (SAI1.BCR2 & ~SAI_BCR2_FTH) | ((val<<0) & SAI_BCR2_FTH); }
static inline uint32_t sai_bcr2_get_comp(void) { return (SAI1.BCR2 & SAI_BCR2_COMP) >> 14 ; }
static inline uint32_t sai_bcr2_get_mutecn(void) { return (SAI1.BCR2 & SAI_BCR2_MUTECN) >> 7 ; }
static inline uint32_t sai_bcr2_get_fth(void) { return (SAI1.BCR2 & SAI_BCR2_FTH) >> 0 ; }
...
static inline void sai_bfrcr_set_fsall(uint32_t val) { SAI1.BFRCR = (SAI1.BFRCR & ~SAI_BFRCR_FSALL) | ((val<<8) & SAI_BFRCR_FSALL); }
static inline void sai_bfrcr_set_frl(uint32_t val) { SAI1.BFRCR = (SAI1.BFRCR & ~SAI_BFRCR_FRL) | ((val<<0) & SAI_BFRCR_FRL); }
static inline uint32_t sai_bfrcr_get_fsall(void) { return (SAI1.BFRCR & SAI_BFRCR_FSALL) >> 8 ; }
static inline uint32_t sai_bfrcr_get_frl(void) { return (SAI1.BFRCR & SAI_BFRCR_FRL) >> 0 ; }
...
static inline void sai_bslotr_set_sloten(uint32_t val) { SAI1.BSLOTR = (SAI1.BSLOTR & ~SAI_BSLOTR_SLOTEN) | ((val<<16) & SAI_BSLOTR_SLOTEN); }
static inline void sai_bslotr_set_nbslot(uint32_t val) { SAI1.BSLOTR = (SAI1.BSLOTR & ~SAI_BSLOTR_NBSLOT) | ((val<<8) & SAI_BSLOTR_NBSLOT); }
static inline void sai_bslotr_set_slotsz(uint32_t val) { SAI1.BSLOTR = (SAI1.BSLOTR & ~SAI_BSLOTR_SLOTSZ) | ((val<<6) & SAI_BSLOTR_SLOTSZ); }
static inline void sai_bslotr_set_fboff(uint32_t val) { SAI1.BSLOTR = (SAI1.BSLOTR & ~SAI_BSLOTR_FBOFF) | ((val<<0) & SAI_BSLOTR_FBOFF); }
static inline uint32_t sai_bslotr_get_sloten(void) { return (SAI1.BSLOTR & SAI_BSLOTR_SLOTEN) >> 16 ; }
static inline uint32_t sai_bslotr_get_nbslot(void) { return (SAI1.BSLOTR & SAI_BSLOTR_NBSLOT) >> 8 ; }
static inline uint32_t sai_bslotr_get_slotsz(void) { return (SAI1.BSLOTR & SAI_BSLOTR_SLOTSZ) >> 6 ; }
static inline uint32_t sai_bslotr_get_fboff(void) { return (SAI1.BSLOTR & SAI_BSLOTR_FBOFF) >> 0 ; }
...
static inline uint32_t sai_bsr_get_flvl(void) { return (SAI1.BSR & SAI_BSR_FLVL) >> 16 ; }
...
static inline void swpmi_brr_set_br(uint32_t val) { SWPMI1.BRR = (SWPMI1.BRR & ~SWPMI_BRR_BR) | ((val<<0) & SWPMI_BRR_BR); }
static inline uint32_t swpmi_brr_get_br(void) { return (SWPMI1.BRR & SWPMI_BRR_BR) >> 0 ; }
...
static inline uint32_t swpmi_rfl_get_rfl(void) { return (SWPMI1.RFL & SWPMI_RFL_RFL) >> 0 ; }
...
static inline void tim15_dmar_set_dmab(uint32_t val) { TIM15.DMAR = (TIM15.DMAR & ~TIM15_DMAR_DMAB) | ((val<<0) & TIM15_DMAR_DMAB); }
static inline uint32_t tim15_dmar_get_dmab(void) { return (TIM15.DMAR & TIM15_DMAR_DMAB) >> 0 ; }

// TIM15->OR1 Option Register 1
enum {
	TIM15_OR1_ENCMODE = ((1UL<<2)-1) << 1, // 00: No redirection 01:TIM2 IC1 and TIM2 IC2 are connected to TIM15 IC1 and TIM15 IC2 respectively 10:Reserved 11:Reserved
	TIM15_OR1_TI1_RMP = 1UL<<0, // 0: TIM15 input capture 1 is connected to I/O 1: TIM15 input capture 1 is connected to LSE		
};
static inline void tim15_or1_set_encmode(uint32_t val) { TIM15.OR1 = (TIM15.OR1 & ~TIM15_OR1_ENCMODE) | ((val<<1) & TIM15_OR1_ENCMODE); }
...
static inline void tim16_ccr1_set_ccr1(uint32_t val) { TIM16.CCR1 = (TIM16.CCR1 & ~TIM16_CCR1_CCR1) | ((val<<0) & TIM16_CCR1_CCR1); }
...
static inline void tim16_dmar_set_dmab(uint32_t val) { TIM16.DMAR = (TIM16.DMAR & ~TIM16_DMAR_DMAB) | ((val<<0) & TIM16_DMAR_DMAB); }
...
/* General-purpose-timers
There is only one peripheral of type TIM2. */
struct TIM2_Type {
	__IO uint32_t CR1; // @0 control register 1
	__IO uint32_t CR2; // @4 control register 2
	__IO uint32_t SMCR; // @8 slave mode control register
...
static inline void tim2_cr1_set_ckd(uint32_t val) { TIM2.CR1 = (TIM2.CR1 & ~TIM2_CR1_CKD) | ((val<<8) & TIM2_CR1_CKD); }
static inline void tim2_cr1_set_cms(uint32_t val) { TIM2.CR1 = (TIM2.CR1 & ~TIM2_CR1_CMS) | ((val<<5) & TIM2_CR1_CMS); }
static inline uint32_t tim2_cr1_get_ckd(void) { return (TIM2.CR1 & TIM2_CR1_CKD) >> 8 ; }
static inline uint32_t tim2_cr1_get_cms(void) { return (TIM2.CR1 & TIM2_CR1_CMS) >> 5 ; }
...
static inline void tim2_cr2_set_mms(uint32_t val) { TIM2.CR2 = (TIM2.CR2 & ~TIM2_CR2_MMS) | ((val<<4) & TIM2_CR2_MMS); }
static inline uint32_t tim2_cr2_get_mms(void) { return (TIM2.CR2 & TIM2_CR2_MMS) >> 4 ; }
...
static inline void tim2_smcr_set_etps(uint32_t val) { TIM2.SMCR = (TIM2.SMCR & ~TIM2_SMCR_ETPS) | ((val<<12) & TIM2_SMCR_ETPS); }
static inline void tim2_smcr_set_etf(uint32_t val) { TIM2.SMCR = (TIM2.SMCR & ~TIM2_SMCR_ETF) | ((val<<8) & TIM2_SMCR_ETF); }
static inline void tim2_smcr_set_ts(uint32_t val) { TIM2.SMCR = (TIM2.SMCR & ~TIM2_SMCR_TS) | ((val<<4) & TIM2_SMCR_TS); }
static inline void tim2_smcr_set_sms(uint32_t val) { TIM2.SMCR = (TIM2.SMCR & ~TIM2_SMCR_SMS) | ((val<<0) & TIM2_SMCR_SMS); }
static inline uint32_t tim2_smcr_get_etps(void) { return (TIM2.SMCR & TIM2_SMCR_ETPS) >> 12 ; }
static inline uint32_t tim2_smcr_get_etf(void) { return (TIM2.SMCR & TIM2_SMCR_ETF) >> 8 ; }
static inline uint32_t tim2_smcr_get_ts(void) { return (TIM2.SMCR & TIM2_SMCR_TS) >> 4 ; }
static inline uint32_t tim2_smcr_get_sms(void) { return (TIM2.SMCR & TIM2_SMCR_SMS) >> 0 ; }
...
static inline void tim2_ccmr1_output_set_oc2m(uint32_t val) { TIM2.CCMR1_Output = (TIM2.CCMR1_Output & ~TIM2_CCMR1_OUTPUT_OC2M) | ((val<<12) & TIM2_CCMR1_OUTPUT_OC2M); }
static inline void tim2_ccmr1_output_set_cc2s(uint32_t val) { TIM2.CCMR1_Output = (TIM2.CCMR1_Output & ~TIM2_CCMR1_OUTPUT_CC2S) | ((val<<8) & TIM2_CCMR1_OUTPUT_CC2S); }
static inline void tim2_ccmr1_output_set_oc1m(uint32_t val) { TIM2.CCMR1_Output = (TIM2.CCMR1_Output & ~TIM2_CCMR1_OUTPUT_OC1M) | ((val<<4) & TIM2_CCMR1_OUTPUT_OC1M); }
static inline void tim2_ccmr1_output_set_cc1s(uint32_t val) { TIM2.CCMR1_Output = (TIM2.CCMR1_Output & ~TIM2_CCMR1_OUTPUT_CC1S) | ((val<<0) & TIM2_CCMR1_OUTPUT_CC1S); }
static inline uint32_t tim2_ccmr1_output_get_oc2m(void) { return (TIM2.CCMR1_Output & TIM2_CCMR1_OUTPUT_OC2M) >> 12 ; }
static inline uint32_t tim2_ccmr1_output_get_cc2s(void) { return (TIM2.CCMR1_Output & TIM2_CCMR1_OUTPUT_CC2S) >> 8 ; }
static inline uint32_t tim2_ccmr1_output_get_oc1m(void) { return (TIM2.CCMR1_Output & TIM2_CCMR1_OUTPUT_OC1M) >> 4 ; }
static inline uint32_t tim2_ccmr1_output_get_cc1s(void) { return (TIM2.CCMR1_Output & TIM2_CCMR1_OUTPUT_CC1S) >> 0 ; }
...
static inline void tim2_ccmr2_output_set_oc4m(uint32_t val) { TIM2.CCMR2_Output = (TIM2.CCMR2_Output & ~TIM2_CCMR2_OUTPUT_OC4M) | ((val<<12) & TIM2_CCMR2_OUTPUT_OC4M); }
static inline void tim2_ccmr2_output_set_cc4s(uint32_t val) { TIM2.CCMR2_Output = (TIM2.CCMR2_Output & ~TIM2_CCMR2_OUTPUT_CC4S) | ((val<<8) & TIM2_CCMR2_OUTPUT_CC4S); }
static inline void tim2_ccmr2_output_set_oc3m(uint32_t val) { TIM2.CCMR2_Output = (TIM2.CCMR2_Output & ~TIM2_CCMR2_OUTPUT_OC3M) | ((val<<4) & TIM2_CCMR2_OUTPUT_OC3M); }
static inline void tim2_ccmr2_output_set_cc3s(uint32_t val) { TIM2.CCMR2_Output = (TIM2.CCMR2_Output & ~TIM2_CCMR2_OUTPUT_CC3S) | ((val<<0) & TIM2_CCMR2_OUTPUT_CC3S); }
static inline uint32_t tim2_ccmr2_output_get_oc4m(void) { return (TIM2.CCMR2_Output & TIM2_CCMR2_OUTPUT_OC4M) >> 12 ; }
static inline uint32_t tim2_ccmr2_output_get_cc4s(void) { return (TIM2.CCMR2_Output & TIM2_CCMR2_OUTPUT_CC4S) >> 8 ; }
static inline uint32_t tim2_ccmr2_output_get_oc3m(void) { return (TIM2.CCMR2_Output & TIM2_CCMR2_OUTPUT_OC3M) >> 4 ; }
static inline uint32_t tim2_ccmr2_output_get_cc3s(void) { return (TIM2.CCMR2_Output & TIM2_CCMR2_OUTPUT_CC3S) >> 0 ; }
...
static inline void tim2_cnt_set_cnt_h(uint32_t val) { TIM2.CNT = (TIM2.CNT & ~TIM2_CNT_CNT_H) | ((val<<16) & TIM2_CNT_CNT_H); }
static inline void tim2_cnt_set_cnt_l(uint32_t val) { TIM2.CNT = (TIM2.CNT & ~TIM2_CNT_CNT_L) | ((val<<0) & TIM2_CNT_CNT_L); }
static inline uint32_t tim2_cnt_get_cnt_h(void) { return (TIM2.CNT & TIM2_CNT_CNT_H) >> 16 ; }
static inline uint32_t tim2_cnt_get_cnt_l(void) { return (TIM2.CNT & TIM2_CNT_CNT_L) >> 0 ; }

// TIM2->PSC prescaler
enum {
	TIM2_PSC_PSC = ((1UL<<16)-1) << 0, // Prescaler value		
};
static inline void tim2_psc_set_psc(uint32_t val) { TIM2.PSC = (TIM2.PSC & ~TIM2_PSC_PSC) | ((val<<0) & TIM2_PSC_PSC); }
static inline uint32_t tim2_psc_get_psc(void) { return (TIM2.PSC & TIM2_PSC_PSC) >> 0 ; }
...
static inline void tim2_arr_set_arr_h(uint32_t val) { TIM2.ARR = (TIM2.ARR & ~TIM2_ARR_ARR_H) | ((val<<16) & TIM2_ARR_ARR_H); }
static inline void tim2_arr_set_arr_l(uint32_t val) { TIM2.ARR = (TIM2.ARR & ~TIM2_ARR_ARR_L) | ((val<<0) & TIM2_ARR_ARR_L); }
static inline uint32_t tim2_arr_get_arr_h(void) { return (TIM2.ARR & TIM2_ARR_ARR_H) >> 16 ; }
static inline uint32_t tim2_arr_get_arr_l(void) { return (TIM2.ARR & TIM2_ARR_ARR_L) >> 0 ; }
...
static inline void tim2_ccr1_set_ccr1_h(uint32_t val) { TIM2.CCR1 = (TIM2.CCR1 & ~TIM2_CCR1_CCR1_H) | ((val<<16) & TIM2_CCR1_CCR1_H); }
static inline void tim2_ccr1_set_ccr1_l(uint32_t val) { TIM2.CCR1 = (TIM2.CCR1 & ~TIM2_CCR1_CCR1_L) | ((val<<0) & TIM2_CCR1_CCR1_L); }
static inline uint32_t tim2_ccr1_get_ccr1_h(void) { return (TIM2.CCR1 & TIM2_CCR1_CCR1_H) >> 16 ; }
static inline uint32_t tim2_ccr1_get_ccr1_l(void) { return (TIM2.CCR1 & TIM2_CCR1_CCR1_L) >> 0 ; }
...
static inline void tim2_ccr2_set_ccr2_h(uint32_t val) { TIM2.CCR2 = (TIM2.CCR2 & ~TIM2_CCR2_CCR2_H) | ((val<<16) & TIM2_CCR2_CCR2_H); }
static inline void tim2_ccr2_set_ccr2_l(uint32_t val) { TIM2.CCR2 = (TIM2.CCR2 & ~TIM2_CCR2_CCR2_L) | ((val<<0) & TIM2_CCR2_CCR2_L); }
static inline uint32_t tim2_ccr2_get_ccr2_h(void) { return (TIM2.CCR2 & TIM2_CCR2_CCR2_H) >> 16 ; }
static inline uint32_t tim2_ccr2_get_ccr2_l(void) { return (TIM2.CCR2 & TIM2_CCR2_CCR2_L) >> 0 ; }
...
static inline void tim2_ccr3_set_ccr3_h(uint32_t val) { TIM2.CCR3 = (TIM2.CCR3 & ~TIM2_CCR3_CCR3_H) | ((val<<16) & TIM2_CCR3_CCR3_H); }
static inline void tim2_ccr3_set_ccr3_l(uint32_t val) { TIM2.CCR3 = (TIM2.CCR3 & ~TIM2_CCR3_CCR3_L) | ((val<<0) & TIM2_CCR3_CCR3_L); }
static inline uint32_t tim2_ccr3_get_ccr3_h(void) { return (TIM2.CCR3 & TIM2_CCR3_CCR3_H) >> 16 ; }
static inline uint32_t tim2_ccr3_get_ccr3_l(void) { return (TIM2.CCR3 & TIM2_CCR3_CCR3_L) >> 0 ; }
...
static inline void tim2_ccr4_set_ccr4_h(uint32_t val) { TIM2.CCR4 = (TIM2.CCR4 & ~TIM2_CCR4_CCR4_H) | ((val<<16) & TIM2_CCR4_CCR4_H); }
static inline void tim2_ccr4_set_ccr4_l(uint32_t val) { TIM2.CCR4 = (TIM2.CCR4 & ~TIM2_CCR4_CCR4_L) | ((val<<0) & TIM2_CCR4_CCR4_L); }
static inline uint32_t tim2_ccr4_get_ccr4_h(void) { return (TIM2.CCR4 & TIM2_CCR4_CCR4_H) >> 16 ; }
static inline uint32_t tim2_ccr4_get_ccr4_l(void) { return (TIM2.CCR4 & TIM2_CCR4_CCR4_L) >> 0 ; }
...
static inline void tim2_dcr_set_dbl(uint32_t val) { TIM2.DCR = (TIM2.DCR & ~TIM2_DCR_DBL) | ((val<<8) & TIM2_DCR_DBL); }
static inline void tim2_dcr_set_dba(uint32_t val) { TIM2.DCR = (TIM2.DCR & ~TIM2_DCR_DBA) | ((val<<0) & TIM2_DCR_DBA); }
static inline uint32_t tim2_dcr_get_dbl(void) { return (TIM2.DCR & TIM2_DCR_DBL) >> 8 ; }
static inline uint32_t tim2_dcr_get_dba(void) { return (TIM2.DCR & TIM2_DCR_DBA) >> 0 ; }

// TIM2->DMAR DMA address for full transfer
enum {
	TIM2_DMAR_DMAB = ((1UL<<16)-1) << 0, // DMA register for burst accesses		
};
static inline void tim2_dmar_set_dmab(uint32_t val) { TIM2.DMAR = (TIM2.DMAR & ~TIM2_DMAR_DMAB) | ((val<<0) & TIM2_DMAR_DMAB); }
static inline uint32_t tim2_dmar_get_dmab(void) { return (TIM2.DMAR & TIM2_DMAR_DMAB) >> 0 ; }
...
static inline void tim2_or_set_ti4_rmp(uint32_t val) { TIM2.OR = (TIM2.OR & ~TIM2_OR_TI4_RMP) | ((val<<3) & TIM2_OR_TI4_RMP); }
static inline void tim2_or_set_etr_rmp(uint32_t val) { TIM2.OR = (TIM2.OR & ~TIM2_OR_ETR_RMP) | ((val<<0) & TIM2_OR_ETR_RMP); }
static inline uint32_t tim2_or_get_ti4_rmp(void) { return (TIM2.OR & TIM2_OR_TI4_RMP) >> 3 ; }
static inline uint32_t tim2_or_get_etr_rmp(void) { return (TIM2.OR & TIM2_OR_ETR_RMP) >> 0 ; }
...
static inline void tsc_cr_set_ctph(uint32_t val) { TSC.CR = (TSC.CR & ~TSC_CR_CTPH) | ((val<<28) & TSC_CR_CTPH); }
static inline void tsc_cr_set_ctpl(uint32_t val) { TSC.CR = (TSC.CR & ~TSC_CR_CTPL) | ((val<<24) & TSC_CR_CTPL); }
static inline void tsc_cr_set_ssd(uint32_t val) { TSC.CR = (TSC.CR & ~TSC_CR_SSD) | ((val<<17) & TSC_CR_SSD); }
static inline void tsc_cr_set_pgpsc(uint32_t val) { TSC.CR = (TSC.CR & ~TSC_CR_PGPSC) | ((val<<12) & TSC_CR_PGPSC); }
static inline void tsc_cr_set_mcv(uint32_t val) { TSC.CR = (TSC.CR & ~TSC_CR_MCV) | ((val<<5) & TSC_CR_MCV); }
static inline uint32_t tsc_cr_get_ctph(void) { return (TSC.CR & TSC_CR_CTPH) >> 28 ; }
static inline uint32_t tsc_cr_get_ctpl(void) { return (TSC.CR & TSC_CR_CTPL) >> 24 ; }
static inline uint32_t tsc_cr_get_ssd(void) { return (TSC.CR & TSC_CR_SSD) >> 17 ; }
static inline uint32_t tsc_cr_get_pgpsc(void) { return (TSC.CR & TSC_CR_PGPSC) >> 12 ; }
static inline uint32_t tsc_cr_get_mcv(void) { return (TSC.CR & TSC_CR_MCV) >> 5 ; }
...
static inline uint32_t tsc_iog1cr_get_cnt(void) { return (TSC.IOG1CR & TSC_IOG1CR_CNT) >> 0 ; }

// TSC->IOG2CR I/O group x counter register
enum {
	TSC_IOG2CR_CNT = ((1UL<<14)-1) << 0, // Counter value		
};
static inline uint32_t tsc_iog2cr_get_cnt(void) { return (TSC.IOG2CR & TSC_IOG2CR_CNT) >> 0 ; }

// TSC->IOG3CR I/O group x counter register
enum {
	TSC_IOG3CR_CNT = ((1UL<<14)-1) << 0, // Counter value		
};
static inline uint32_t tsc_iog3cr_get_cnt(void) { return (TSC.IOG3CR & TSC_IOG3CR_CNT) >> 0 ; }

// TSC->IOG4CR I/O group x counter register
enum {
	TSC_IOG4CR_CNT = ((1UL<<14)-1) << 0, // Counter value		
};
static inline uint32_t tsc_iog4cr_get_cnt(void) { return (TSC.IOG4CR & TSC_IOG4CR_CNT) >> 0 ; }

// TSC->IOG5CR I/O group x counter register
enum {
	TSC_IOG5CR_CNT = ((1UL<<14)-1) << 0, // Counter value		
};
static inline uint32_t tsc_iog5cr_get_cnt(void) { return (TSC.IOG5CR & TSC_IOG5CR_CNT) >> 0 ; }

// TSC->IOG6CR I/O group x counter register
enum {
	TSC_IOG6CR_CNT = ((1UL<<14)-1) << 0, // Counter value		
};
static inline uint32_t tsc_iog6cr_get_cnt(void) { return (TSC.IOG6CR & TSC_IOG6CR_CNT) >> 0 ; }

// TSC->IOG7CR I/O group x counter register
enum {
	TSC_IOG7CR_CNT = ((1UL<<14)-1) << 0, // Counter value		
};
static inline uint32_t tsc_iog7cr_get_cnt(void) { return (TSC.IOG7CR & TSC_IOG7CR_CNT) >> 0 ; }

// TSC->IOG8CR I/O group x counter register
enum {
	TSC_IOG8CR_CNT = ((1UL<<14)-1) << 0, // Counter value		
};
static inline uint32_t tsc_iog8cr_get_cnt(void) { return (TSC.IOG8CR & TSC_IOG8CR_CNT) >> 0 ; }
...
static inline void usart_cr2_set_add(struct USART_Type* p, uint32_t val) { p->CR2 = (p->CR2 & ~USART_CR2_ADD) | ((val<<24) & USART_CR2_ADD); }
static inline void usart_cr2_set_abrmod(struct USART_Type* p, uint32_t val) { p->CR2 = (p->CR2 & ~USART_CR2_ABRMOD) | ((val<<21) & USART_CR2_ABRMOD); }
...
extern struct USB_FS_Type	USB_SRAM;	// @0x40006C00 
extern struct USB_FS_Type 	USB_FS;	// @0x40006800

// USB_FS->EP0R endpoint 0 register
enum {
	USB_FS_EP0R_CTR_RX = 1UL<<15, // Correct transfer for reception
	USB_FS_EP0R_DTOG_RX = 1UL<<14, // Data Toggle, for reception transfers
	USB_FS_EP0R_STAT_RX = ((1UL<<2)-1) << 12, // Status bits, for reception transfers
	USB_FS_EP0R_SETUP = 1UL<<11, // Setup transaction completed
	USB_FS_EP0R_EP_TYPE = ((1UL<<2)-1) << 9, // Endpoint type
	USB_FS_EP0R_EP_KIND = 1UL<<8, // Endpoint kind
	USB_FS_EP0R_CTR_TX = 1UL<<7, // Correct Transfer for transmission
	USB_FS_EP0R_DTOG_TX = 1UL<<6, // Data Toggle, for transmission transfers
	USB_FS_EP0R_STAT_TX = ((1UL<<2)-1) << 4, // Status bits, for transmission transfers
	USB_FS_EP0R_EA = ((1UL<<4)-1) << 0, // Endpoint address		
};
static inline void usb_fs_ep0r_set_stat_rx(struct USB_FS_Type* p, uint32_t val) { p->EP0R = (p->EP0R & ~USB_FS_EP0R_STAT_RX) | ((val<<12) & USB_FS_EP0R_STAT_RX); }
static inline void usb_fs_ep0r_set_ep_type(struct USB_FS_Type* p, uint32_t val) { p->EP0R = (p->EP0R & ~USB_FS_EP0R_EP_TYPE) | ((val<<9) & USB_FS_EP0R_EP_TYPE); }
static inline void usb_fs_ep0r_set_stat_tx(struct USB_FS_Type* p, uint32_t val) { p->EP0R = (p->EP0R & ~USB_FS_EP0R_STAT_TX) | ((val<<4) & USB_FS_EP0R_STAT_TX); }
static inline void usb_fs_ep0r_set_ea(struct USB_FS_Type* p, uint32_t val) { p->EP0R = (p->EP0R & ~USB_FS_EP0R_EA) | ((val<<0) & USB_FS_EP0R_EA); }
static inline uint32_t usb_fs_ep0r_get_stat_rx(struct USB_FS_Type* p) { return (p->EP0R & USB_FS_EP0R_STAT_RX) >> 12 ; }
static inline uint32_t usb_fs_ep0r_get_ep_type(struct USB_FS_Type* p) { return (p->EP0R & USB_FS_EP0R_EP_TYPE) >> 9 ; }
static inline uint32_t usb_fs_ep0r_get_stat_tx(struct USB_FS_Type* p) { return (p->EP0R & USB_FS_EP0R_STAT_TX) >> 4 ; }
static inline uint32_t usb_fs_ep0r_get_ea(struct USB_FS_Type* p) { return (p->EP0R & USB_FS_EP0R_EA) >> 0 ; }

// USB_FS->EP1R endpoint 1 register
enum {
	USB_FS_EP1R_CTR_RX = 1UL<<15, // Correct transfer for reception
	USB_FS_EP1R_DTOG_RX = 1UL<<14, // Data Toggle, for reception transfers
	USB_FS_EP1R_STAT_RX = ((1UL<<2)-1) << 12, // Status bits, for reception transfers
	USB_FS_EP1R_SETUP = 1UL<<11, // Setup transaction completed
	USB_FS_EP1R_EP_TYPE = ((1UL<<2)-1) << 9, // Endpoint type
	USB_FS_EP1R_EP_KIND = 1UL<<8, // Endpoint kind
	USB_FS_EP1R_CTR_TX = 1UL<<7, // Correct Transfer for transmission
	USB_FS_EP1R_DTOG_TX = 1UL<<6, // Data Toggle, for transmission transfers
	USB_FS_EP1R_STAT_TX = ((1UL<<2)-1) << 4, // Status bits, for transmission transfers
	USB_FS_EP1R_EA = ((1UL<<4)-1) << 0, // Endpoint address		
};
static inline void usb_fs_ep1r_set_stat_rx(struct USB_FS_Type* p, uint32_t val) { p->EP1R = (p->EP1R & ~USB_FS_EP1R_STAT_RX) | ((val<<12) & USB_FS_EP1R_STAT_RX); }
static inline void usb_fs_ep1r_set_ep_type(struct USB_FS_Type* p, uint32_t val) { p->EP1R = (p->EP1R & ~USB_FS_EP1R_EP_TYPE) | ((val<<9) & USB_FS_EP1R_EP_TYPE); }
static inline void usb_fs_ep1r_set_stat_tx(struct USB_FS_Type* p, uint32_t val) { p->EP1R = (p->EP1R & ~USB_FS_EP1R_STAT_TX) | ((val<<4) & USB_FS_EP1R_STAT_TX); }
static inline void usb_fs_ep1r_set_ea(struct USB_FS_Type* p, uint32_t val) { p->EP1R = (p->EP1R & ~USB_FS_EP1R_EA) | ((val<<0) & USB_FS_EP1R_EA); }
static inline uint32_t usb_fs_ep1r_get_stat_rx(struct USB_FS_Type* p) { return (p->EP1R & USB_FS_EP1R_STAT_RX) >> 12 ; }
static inline uint32_t usb_fs_ep1r_get_ep_type(struct USB_FS_Type* p) { return (p->EP1R & USB_FS_EP1R_EP_TYPE) >> 9 ; }
static inline uint32_t usb_fs_ep1r_get_stat_tx(struct USB_FS_Type* p) { return (p->EP1R & USB_FS_EP1R_STAT_TX) >> 4 ; }
static inline uint32_t usb_fs_ep1r_get_ea(struct USB_FS_Type* p) { return (p->EP1R & USB_FS_EP1R_EA) >> 0 ; }

// USB_FS->EP2R endpoint 2 register
enum {
	USB_FS_EP2R_CTR_RX = 1UL<<15, // Correct transfer for reception
	USB_FS_EP2R_DTOG_RX = 1UL<<14, // Data Toggle, for reception transfers
	USB_FS_EP2R_STAT_RX = ((1UL<<2)-1) << 12, // Status bits, for reception transfers
	USB_FS_EP2R_SETUP = 1UL<<11, // Setup transaction completed
	USB_FS_EP2R_EP_TYPE = ((1UL<<2)-1) << 9, // Endpoint type
	USB_FS_EP2R_EP_KIND = 1UL<<8, // Endpoint kind
	USB_FS_EP2R_CTR_TX = 1UL<<7, // Correct Transfer for transmission
	USB_FS_EP2R_DTOG_TX = 1UL<<6, // Data Toggle, for transmission transfers
	USB_FS_EP2R_STAT_TX = ((1UL<<2)-1) << 4, // Status bits, for transmission transfers
	USB_FS_EP2R_EA = ((1UL<<4)-1) << 0, // Endpoint address		
};
static inline void usb_fs_ep2r_set_stat_rx(struct USB_FS_Type* p, uint32_t val) { p->EP2R = (p->EP2R & ~USB_FS_EP2R_STAT_RX) | ((val<<12) & USB_FS_EP2R_STAT_RX); }
static inline void usb_fs_ep2r_set_ep_type(struct USB_FS_Type* p, uint32_t val) { p->EP2R = (p->EP2R & ~USB_FS_EP2R_EP_TYPE) | ((val<<9) & USB_FS_EP2R_EP_TYPE); }
static inline void usb_fs_ep2r_set_stat_tx(struct USB_FS_Type* p, uint32_t val) { p->EP2R = (p->EP2R & ~USB_FS_EP2R_STAT_TX) | ((val<<4) & USB_FS_EP2R_STAT_TX); }
static inline void usb_fs_ep2r_set_ea(struct USB_FS_Type* p, uint32_t val) { p->EP2R = (p->EP2R & ~USB_FS_EP2R_EA) | ((val<<0) & USB_FS_EP2R_EA); }
static inline uint32_t usb_fs_ep2r_get_stat_rx(struct USB_FS_Type* p) { return (p->EP2R & USB_FS_EP2R_STAT_RX) >> 12 ; }
static inline uint32_t usb_fs_ep2r_get_ep_type(struct USB_FS_Type* p) { return (p->EP2R & USB_FS_EP2R_EP_TYPE) >> 9 ; }
static inline uint32_t usb_fs_ep2r_get_stat_tx(struct USB_FS_Type* p) { return (p->EP2R & USB_FS_EP2R_STAT_TX) >> 4 ; }
static inline uint32_t usb_fs_ep2r_get_ea(struct USB_FS_Type* p) { return (p->EP2R & USB_FS_EP2R_EA) >> 0 ; }

// USB_FS->EP3R endpoint 3 register
enum {
	USB_FS_EP3R_CTR_RX = 1UL<<15, // Correct transfer for reception
	USB_FS_EP3R_DTOG_RX = 1UL<<14, // Data Toggle, for reception transfers
	USB_FS_EP3R_STAT_RX = ((1UL<<2)-1) << 12, // Status bits, for reception transfers
	USB_FS_EP3R_SETUP = 1UL<<11, // Setup transaction completed
	USB_FS_EP3R_EP_TYPE = ((1UL<<2)-1) << 9, // Endpoint type
	USB_FS_EP3R_EP_KIND = 1UL<<8, // Endpoint kind
	USB_FS_EP3R_CTR_TX = 1UL<<7, // Correct Transfer for transmission
	USB_FS_EP3R_DTOG_TX = 1UL<<6, // Data Toggle, for transmission transfers
	USB_FS_EP3R_STAT_TX = ((1UL<<2)-1) << 4, // Status bits, for transmission transfers
	USB_FS_EP3R_EA = ((1UL<<4)-1) << 0, // Endpoint address		
};
static inline void usb_fs_ep3r_set_stat_rx(struct USB_FS_Type* p, uint32_t val) { p->EP3R = (p->EP3R & ~USB_FS_EP3R_STAT_RX) | ((val<<12) & USB_FS_EP3R_STAT_RX); }
static inline void usb_fs_ep3r_set_ep_type(struct USB_FS_Type* p, uint32_t val) { p->EP3R = (p->EP3R & ~USB_FS_EP3R_EP_TYPE) | ((val<<9) & USB_FS_EP3R_EP_TYPE); }
static inline void usb_fs_ep3r_set_stat_tx(struct USB_FS_Type* p, uint32_t val) { p->EP3R = (p->EP3R & ~USB_FS_EP3R_STAT_TX) | ((val<<4) & USB_FS_EP3R_STAT_TX); }
static inline void usb_fs_ep3r_set_ea(struct USB_FS_Type* p, uint32_t val) { p->EP3R = (p->EP3R & ~USB_FS_EP3R_EA) | ((val<<0) & USB_FS_EP3R_EA); }
static inline uint32_t usb_fs_ep3r_get_stat_rx(struct USB_FS_Type* p) { return (p->EP3R & USB_FS_EP3R_STAT_RX) >> 12 ; }
static inline uint32_t usb_fs_ep3r_get_ep_type(struct USB_FS_Type* p) { return (p->EP3R & USB_FS_EP3R_EP_TYPE) >> 9 ; }
static inline uint32_t usb_fs_ep3r_get_stat_tx(struct USB_FS_Type* p) { return (p->EP3R & USB_FS_EP3R_STAT_TX) >> 4 ; }
static inline uint32_t usb_fs_ep3r_get_ea(struct USB_FS_Type* p) { return (p->EP3R & USB_FS_EP3R_EA) >> 0 ; }

// USB_FS->EP4R endpoint 4 register
enum {
	USB_FS_EP4R_CTR_RX = 1UL<<15, // Correct transfer for reception
	USB_FS_EP4R_DTOG_RX = 1UL<<14, // Data Toggle, for reception transfers
	USB_FS_EP4R_STAT_RX = ((1UL<<2)-1) << 12, // Status bits, for reception transfers
	USB_FS_EP4R_SETUP = 1UL<<11, // Setup transaction completed
	USB_FS_EP4R_EP_TYPE = ((1UL<<2)-1) << 9, // Endpoint type
	USB_FS_EP4R_EP_KIND = 1UL<<8, // Endpoint kind
	USB_FS_EP4R_CTR_TX = 1UL<<7, // Correct Transfer for transmission
	USB_FS_EP4R_DTOG_TX = 1UL<<6, // Data Toggle, for transmission transfers
	USB_FS_EP4R_STAT_TX = ((1UL<<2)-1) << 4, // Status bits, for transmission transfers
	USB_FS_EP4R_EA = ((1UL<<4)-1) << 0, // Endpoint address		
};
static inline void usb_fs_ep4r_set_stat_rx(struct USB_FS_Type* p, uint32_t val) { p->EP4R = (p->EP4R & ~USB_FS_EP4R_STAT_RX) | ((val<<12) & USB_FS_EP4R_STAT_RX); }
static inline void usb_fs_ep4r_set_ep_type(struct USB_FS_Type* p, uint32_t val) { p->EP4R = (p->EP4R & ~USB_FS_EP4R_EP_TYPE) | ((val<<9) & USB_FS_EP4R_EP_TYPE); }
static inline void usb_fs_ep4r_set_stat_tx(struct USB_FS_Type* p, uint32_t val) { p->EP4R = (p->EP4R & ~USB_FS_EP4R_STAT_TX) | ((val<<4) & USB_FS_EP4R_STAT_TX); }
static inline void usb_fs_ep4r_set_ea(struct USB_FS_Type* p, uint32_t val) { p->EP4R = (p->EP4R & ~USB_FS_EP4R_EA) | ((val<<0) & USB_FS_EP4R_EA); }
static inline uint32_t usb_fs_ep4r_get_stat_rx(struct USB_FS_Type* p) { return (p->EP4R & USB_FS_EP4R_STAT_RX) >> 12 ; }
static inline uint32_t usb_fs_ep4r_get_ep_type(struct USB_FS_Type* p) { return (p->EP4R & USB_FS_EP4R_EP_TYPE) >> 9 ; }
static inline uint32_t usb_fs_ep4r_get_stat_tx(struct USB_FS_Type* p) { return (p->EP4R & USB_FS_EP4R_STAT_TX) >> 4 ; }
static inline uint32_t usb_fs_ep4r_get_ea(struct USB_FS_Type* p) { return (p->EP4R & USB_FS_EP4R_EA) >> 0 ; }

// USB_FS->EP5R endpoint 5 register
enum {
	USB_FS_EP5R_CTR_RX = 1UL<<15, // Correct transfer for reception
	USB_FS_EP5R_DTOG_RX = 1UL<<14, // Data Toggle, for reception transfers
	USB_FS_EP5R_STAT_RX = ((1UL<<2)-1) << 12, // Status bits, for reception transfers
	USB_FS_EP5R_SETUP = 1UL<<11, // Setup transaction completed
	USB_FS_EP5R_EP_TYPE = ((1UL<<2)-1) << 9, // Endpoint type
	USB_FS_EP5R_EP_KIND = 1UL<<8, // Endpoint kind
	USB_FS_EP5R_CTR_TX = 1UL<<7, // Correct Transfer for transmission
	USB_FS_EP5R_DTOG_TX = 1UL<<6, // Data Toggle, for transmission transfers
	USB_FS_EP5R_STAT_TX = ((1UL<<2)-1) << 4, // Status bits, for transmission transfers
	USB_FS_EP5R_EA = ((1UL<<4)-1) << 0, // Endpoint address		
};
static inline void usb_fs_ep5r_set_stat_rx(struct USB_FS_Type* p, uint32_t val) { p->EP5R = (p->EP5R & ~USB_FS_EP5R_STAT_RX) | ((val<<12) & USB_FS_EP5R_STAT_RX); }
static inline void usb_fs_ep5r_set_ep_type(struct USB_FS_Type* p, uint32_t val) { p->EP5R = (p->EP5R & ~USB_FS_EP5R_EP_TYPE) | ((val<<9) & USB_FS_EP5R_EP_TYPE); }
static inline void usb_fs_ep5r_set_stat_tx(struct USB_FS_Type* p, uint32_t val) { p->EP5R = (p->EP5R & ~USB_FS_EP5R_STAT_TX) | ((val<<4) & USB_FS_EP5R_STAT_TX); }
static inline void usb_fs_ep5r_set_ea(struct USB_FS_Type* p, uint32_t val) { p->EP5R = (p->EP5R & ~USB_FS_EP5R_EA) | ((val<<0) & USB_FS_EP5R_EA); }
static inline uint32_t usb_fs_ep5r_get_stat_rx(struct USB_FS_Type* p) { return (p->EP5R & USB_FS_EP5R_STAT_RX) >> 12 ; }
static inline uint32_t usb_fs_ep5r_get_ep_type(struct USB_FS_Type* p) { return (p->EP5R & USB_FS_EP5R_EP_TYPE) >> 9 ; }
static inline uint32_t usb_fs_ep5r_get_stat_tx(struct USB_FS_Type* p) { return (p->EP5R & USB_FS_EP5R_STAT_TX) >> 4 ; }
static inline uint32_t usb_fs_ep5r_get_ea(struct USB_FS_Type* p) { return (p->EP5R & USB_FS_EP5R_EA) >> 0 ; }

// USB_FS->EP6R endpoint 6 register
enum {
	USB_FS_EP6R_CTR_RX = 1UL<<15, // Correct transfer for reception
	USB_FS_EP6R_DTOG_RX = 1UL<<14, // Data Toggle, for reception transfers
	USB_FS_EP6R_STAT_RX = ((1UL<<2)-1) << 12, // Status bits, for reception transfers
	USB_FS_EP6R_SETUP = 1UL<<11, // Setup transaction completed
	USB_FS_EP6R_EP_TYPE = ((1UL<<2)-1) << 9, // Endpoint type
	USB_FS_EP6R_EP_KIND = 1UL<<8, // Endpoint kind
	USB_FS_EP6R_CTR_TX = 1UL<<7, // Correct Transfer for transmission
	USB_FS_EP6R_DTOG_TX = 1UL<<6, // Data Toggle, for transmission transfers
	USB_FS_EP6R_STAT_TX = ((1UL<<2)-1) << 4, // Status bits, for transmission transfers
	USB_FS_EP6R_EA = ((1UL<<4)-1) << 0, // Endpoint address		
};
static inline void usb_fs_ep6r_set_stat_rx(struct USB_FS_Type* p, uint32_t val) { p->EP6R = (p->EP6R & ~USB_FS_EP6R_STAT_RX) | ((val<<12) & USB_FS_EP6R_STAT_RX); }
static inline void usb_fs_ep6r_set_ep_type(struct USB_FS_Type* p, uint32_t val) { p->EP6R = (p->EP6R & ~USB_FS_EP6R_EP_TYPE) | ((val<<9) & USB_FS_EP6R_EP_TYPE); }
static inline void usb_fs_ep6r_set_stat_tx(struct USB_FS_Type* p, uint32_t val) { p->EP6R = (p->EP6R & ~USB_FS_EP6R_STAT_TX) | ((val<<4) & USB_FS_EP6R_STAT_TX); }
static inline void usb_fs_ep6r_set_ea(struct USB_FS_Type* p, uint32_t val) { p->EP6R = (p->EP6R & ~USB_FS_EP6R_EA) | ((val<<0) & USB_FS_EP6R_EA); }
static inline uint32_t usb_fs_ep6r_get_stat_rx(struct USB_FS_Type* p) { return (p->EP6R & USB_FS_EP6R_STAT_RX) >> 12 ; }
static inline uint32_t usb_fs_ep6r_get_ep_type(struct USB_FS_Type* p) { return (p->EP6R & USB_FS_EP6R_EP_TYPE) >> 9 ; }
static inline uint32_t usb_fs_ep6r_get_stat_tx(struct USB_FS_Type* p) { return (p->EP6R & USB_FS_EP6R_STAT_TX) >> 4 ; }
static inline uint32_t usb_fs_ep6r_get_ea(struct USB_FS_Type* p) { return (p->EP6R & USB_FS_EP6R_EA) >> 0 ; }

// USB_FS->EP7R endpoint 7 register
enum {
	USB_FS_EP7R_CTR_RX = 1UL<<15, // Correct transfer for reception
	USB_FS_EP7R_DTOG_RX = 1UL<<14, // Data Toggle, for reception transfers
	USB_FS_EP7R_STAT_RX = ((1UL<<2)-1) << 12, // Status bits, for reception transfers
	USB_FS_EP7R_SETUP = 1UL<<11, // Setup transaction completed
	USB_FS_EP7R_EP_TYPE = ((1UL<<2)-1) << 9, // Endpoint type
	USB_FS_EP7R_EP_KIND = 1UL<<8, // Endpoint kind
	USB_FS_EP7R_CTR_TX = 1UL<<7, // Correct Transfer for transmission
	USB_FS_EP7R_DTOG_TX = 1UL<<6, // Data Toggle, for transmission transfers
	USB_FS_EP7R_STAT_TX = ((1UL<<2)-1) << 4, // Status bits, for transmission transfers
	USB_FS_EP7R_EA = ((1UL<<4)-1) << 0, // Endpoint address		
};
static inline void usb_fs_ep7r_set_stat_rx(struct USB_FS_Type* p, uint32_t val) { p->EP7R = (p->EP7R & ~USB_FS_EP7R_STAT_RX) | ((val<<12) & USB_FS_EP7R_STAT_RX); }
static inline void usb_fs_ep7r_set_ep_type(struct USB_FS_Type* p, uint32_t val) { p->EP7R = (p->EP7R & ~USB_FS_EP7R_EP_TYPE) | ((val<<9) & USB_FS_EP7R_EP_TYPE); }
static inline void usb_fs_ep7r_set_stat_tx(struct USB_FS_Type* p, uint32_t val) { p->EP7R = (p->EP7R & ~USB_FS_EP7R_STAT_TX) | ((val<<4) & USB_FS_EP7R_STAT_TX); }
static inline void usb_fs_ep7r_set_ea(struct USB_FS_Type* p, uint32_t val) { p->EP7R = (p->EP7R & ~USB_FS_EP7R_EA) | ((val<<0) & USB_FS_EP7R_EA); }
static inline uint32_t usb_fs_ep7r_get_stat_rx(struct USB_FS_Type* p) { return (p->EP7R & USB_FS_EP7R_STAT_RX) >> 12 ; }
static inline uint32_t usb_fs_ep7r_get_ep_type(struct USB_FS_Type* p) { return (p->EP7R & USB_FS_EP7R_EP_TYPE) >> 9 ; }
static inline uint32_t usb_fs_ep7r_get_stat_tx(struct USB_FS_Type* p) { return (p->EP7R & USB_FS_EP7R_STAT_TX) >> 4 ; }
static inline uint32_t usb_fs_ep7r_get_ea(struct USB_FS_Type* p) { return (p->EP7R & USB_FS_EP7R_EA) >> 0 ; }

// USB_FS->CNTR control register
enum {
	USB_FS_CNTR_CTRM = 1UL<<15, // Correct transfer interrupt mask
	USB_FS_CNTR_PMAOVRM = 1UL<<14, // Packet memory area over / underrun interrupt mask
	USB_FS_CNTR_ERRM = 1UL<<13, // Error interrupt mask
	USB_FS_CNTR_WKUPM = 1UL<<12, // Wakeup interrupt mask
	USB_FS_CNTR_SUSPM = 1UL<<11, // Suspend mode interrupt mask
	USB_FS_CNTR_RESETM = 1UL<<10, // USB reset interrupt mask
	USB_FS_CNTR_SOFM = 1UL<<9, // Start of frame interrupt mask
	USB_FS_CNTR_ESOFM = 1UL<<8, // Expected start of frame interrupt mask
	USB_FS_CNTR_L1REQM = 1UL<<7, // LPM L1 state request interrupt mask
	USB_FS_CNTR_L1RESUME = 1UL<<5, // LPM L1 Resume request
	USB_FS_CNTR_RESUME = 1UL<<4, // Resume request
	USB_FS_CNTR_FSUSP = 1UL<<3, // Force suspend
	USB_FS_CNTR_LPMODE = 1UL<<2, // Low-power mode
	USB_FS_CNTR_PDWN = 1UL<<1, // Power down
	USB_FS_CNTR_FRES = 1UL<<0, // Force USB Reset		
};

// USB_FS->ISTR interrupt status register
enum {
	USB_FS_ISTR_CTR = 1UL<<15, // Correct transfer
	USB_FS_ISTR_PMAOVR = 1UL<<14, // Packet memory area over / underrun
	USB_FS_ISTR_ERR = 1UL<<13, // Error
	USB_FS_ISTR_WKUP = 1UL<<12, // Wakeup
	USB_FS_ISTR_SUSP = 1UL<<11, // Suspend mode request
	USB_FS_ISTR_RESET = 1UL<<10, // reset request
	USB_FS_ISTR_SOF = 1UL<<9, // start of frame
	USB_FS_ISTR_ESOF = 1UL<<8, // Expected start frame
	USB_FS_ISTR_L1REQ = 1UL<<7, // LPM L1 state request
	USB_FS_ISTR_DIR = 1UL<<4, // Direction of transaction
	USB_FS_ISTR_EP_ID = ((1UL<<4)-1) << 0, // Endpoint Identifier		
};
static inline void usb_fs_istr_set_ep_id(struct USB_FS_Type* p, uint32_t val) { p->ISTR = (p->ISTR & ~USB_FS_ISTR_EP_ID) | ((val<<0) & USB_FS_ISTR_EP_ID); }
static inline uint32_t usb_fs_istr_get_ep_id(struct USB_FS_Type* p) { return (p->ISTR & USB_FS_ISTR_EP_ID) >> 0 ; }

// USB_FS->FNR frame number register
enum {
	USB_FS_FNR_RXDP = 1UL<<15, // Receive data + line status
	USB_FS_FNR_RXDM = 1UL<<14, // Receive data - line status
	USB_FS_FNR_LCK = 1UL<<13, // Locked
	USB_FS_FNR_LSOF = ((1UL<<2)-1) << 11, // Lost SOF
	USB_FS_FNR_FN = ((1UL<<11)-1) << 0, // Frame number		
};
static inline uint32_t usb_fs_fnr_get_lsof(struct USB_FS_Type* p) { return (p->FNR & USB_FS_FNR_LSOF) >> 11 ; }
static inline uint32_t usb_fs_fnr_get_fn(struct USB_FS_Type* p) { return (p->FNR & USB_FS_FNR_FN) >> 0 ; }

// USB_FS->DADDR device address
enum {
	USB_FS_DADDR_EF = 1UL<<7, // Enable function
	USB_FS_DADDR_ADD = ((1UL<<7)-1) << 0, // Device address		
};
static inline void usb_fs_daddr_set_add(struct USB_FS_Type* p, uint32_t val) { p->DADDR = (p->DADDR & ~USB_FS_DADDR_ADD) | ((val<<0) & USB_FS_DADDR_ADD); }
static inline uint32_t usb_fs_daddr_get_add(struct USB_FS_Type* p) { return (p->DADDR & USB_FS_DADDR_ADD) >> 0 ; }

// USB_FS->BTABLE Buffer table address
enum {
	USB_FS_BTABLE_BTABLE = ((1UL<<13)-1) << 3, // Buffer table		
};
static inline void usb_fs_btable_set_btable(struct USB_FS_Type* p, uint32_t val) { p->BTABLE = (p->BTABLE & ~USB_FS_BTABLE_BTABLE) | ((val<<3) & USB_FS_BTABLE_BTABLE); }
static inline uint32_t usb_fs_btable_get_btable(struct USB_FS_Type* p) { return (p->BTABLE & USB_FS_BTABLE_BTABLE) >> 3 ; }

// USB_FS->LPMCSR LPM control and status register
enum {
	USB_FS_LPMCSR_BESL = ((1UL<<4)-1) << 4, // BESL value
	USB_FS_LPMCSR_REMWAKE = 1UL<<3, // bRemoteWake value
	USB_FS_LPMCSR_LPMACK = 1UL<<1, // LPM Token acknowledge enable
	USB_FS_LPMCSR_LPMEN = 1UL<<0, // LPM support enable		
};
static inline void usb_fs_lpmcsr_set_besl(struct USB_FS_Type* p, uint32_t val) { p->LPMCSR = (p->LPMCSR & ~USB_FS_LPMCSR_BESL) | ((val<<4) & USB_FS_LPMCSR_BESL); }
static inline uint32_t usb_fs_lpmcsr_get_besl(struct USB_FS_Type* p) { return (p->LPMCSR & USB_FS_LPMCSR_BESL) >> 4 ; }

// USB_FS->BCDR Battery charging detector
enum {
	USB_FS_BCDR_DPPU = 1UL<<15, // DP pull-up control
	USB_FS_BCDR_PS2DET = 1UL<<7, // DM pull-up detection status
	USB_FS_BCDR_SDET = 1UL<<6, // Secondary detection
	USB_FS_BCDR_PDET = 1UL<<5, // Primary detection
	USB_FS_BCDR_DCDET = 1UL<<4, // Data contact detection
	USB_FS_BCDR_SDEN = 1UL<<3, // Secondary detection
	USB_FS_BCDR_PDEN = 1UL<<2, // Primary detection
	USB_FS_BCDR_DCDEN = 1UL<<1, // Data contact detection
	USB_FS_BCDR_BCDEN = 1UL<<0, // Battery charging detector		
};
