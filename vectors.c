...
extern void
_estack(void); // fake definition, will be filled in by linker script.

extern void unhandled_interrupt(uint32_t irq); // in fault.c
void default_IRQ_Handler(void) {
  unhandled_interrupt(scb_icsr_get_vectactive());
}

// Core fault handlers
void Reset_Handler(void) __attribute__((weak, alias("default_IRQ_Handler")));
void NonMaskableInt_Handler(void)
    __attribute__((weak, alias("default_IRQ_Handler")));
...
void UsageFault_Handler(void)
    __attribute__((weak, alias("default_IRQ_Handler")));
void Reserved_7_Handler(void)
    __attribute__((weak, alias("default_IRQ_Handler")));
void Reserved_8_Handler(void)
    __attribute__((weak, alias("default_IRQ_Handler")));
void Reserved_9_Handler(void)
    __attribute__((weak, alias("default_IRQ_Handler")));
void Reserved_10_Handler(void)
    __attribute__((weak, alias("default_IRQ_Handler")));
void SVCall_Handler(void) __attribute__((weak, alias("default_IRQ_Handler")));
void DebugMonitor_Handler(void)
    __attribute__((weak, alias("default_IRQ_Handler")));
void Reserved_13_Handler(void)
    __attribute__((weak, alias("default_IRQ_Handler")));
...
__attribute__((section(".isr_vector"))) void (*const vector_table[])(void) = {
    ...
    [16 + RTC_TAMP_STAMP_IRQn] =
        RTC_TAMP_STAMP_Handler, // 2 Tamper and TimeStamp interrupts
    [16 + RTC_WKUP_IRQn] =
        RTC_WKUP_Handler, // 3 RTC Tamper or TimeStamp /CSS on LSE through EXTI
                          // line 19 interrupts
    ...
    [16 +
        DMA1_CH1_IRQn] = DMA1_CH1_Handler, // 11 DMA1 Channel1 global interrupt
    [16 +
        DMA1_CH2_IRQn] = DMA1_CH2_Handler, // 12 DMA1 Channel2 global interrupt
    ...
    [16 + TIM1_BRK_TIM15_IRQn] =
        TIM1_BRK_TIM15_Handler, // 24 Timer 15 global interrupt
    [16 + TIM1_UP_TIM16_IRQn] =
        TIM1_UP_TIM16_Handler, // 25 Timer 16 global interrupt
    [16 + TIM1_TRG_COM_IRQn] =
        TIM1_TRG_COM_Handler, // 26 TIM1 trigger and commutation interrupt
    ...
    [16 + EXTI15_10_IRQn] =
        EXTI15_10_Handler, // 40 EXTI Lines 10 to 15 interrupts
    [16 + RTC_ALARM_IRQn] =
        RTC_ALARM_Handler, // 41 RTC alarms through EXTI line 18 interrupts
    [16 + DFSDM1_FLT3_IRQn] =
        DFSDM1_FLT3_Handler,             // 42 DFSDM1_FLT3 global interrupt
    ...
    [16 + TIM6_DACUNDER_IRQn] =
        TIM6_DACUNDER_Handler, // 54 TIM6 global and DAC1 and 2 underrun error
                               // interrupts
    [16 + TIM7_IRQn] = TIM7_Handler, // 55 TIM7 global interrupt
    [16 +
        DMA2_CH1_IRQn] = DMA2_CH1_Handler, // 56 DMA2 Channel 1 global Interrupt
    [16 +
        DMA2_CH2_IRQn] = DMA2_CH2_Handler, // 57 DMA2 Channel 2 global Interrupt
    [16 +
        DMA2_CH3_IRQn] = DMA2_CH3_Handler, // 58 DMA2 Channel 3 global Interrupt
    [16 +
        DMA2_CH4_IRQn] = DMA2_CH4_Handler, // 59 DMA2 Channel 4 global Interrupt
    [16 +
        DMA2_CH5_IRQn] = DMA2_CH5_Handler, // 60 DMA2 Channel 5 global Interrupt
    ...
    [16 + DFSDM1_FLT2_IRQn] =
        DFSDM1_FLT2_Handler,             // 63 DFSDM1_FLT2 global interrupt
    ...
    [16 +
        DMA2_CH6_IRQn] = DMA2_CH6_Handler, // 68 DMA2 Channel 6 global Interrupt
    [16 +
        DMA2_CH7_IRQn] = DMA2_CH7_Handler, // 69 DMA2 Channel 7 global Interrupt
    ...
    [16 + I2C4_EV_IRQn] =
        I2C4_EV_Handler, // 83 I2C4 event interrupt, wakeup through EXTI
